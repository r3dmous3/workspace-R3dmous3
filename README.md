# com-chilipeppr-workspace-r3dmous3
A ChiliPeppr Workspace r3dmous3.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / r3dmous3
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-r3dmous3 |
| Name                  | Workspace / r3dmous3 |
| Description           | A ChiliPeppr Workspace r3dmous3. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/r3dmous3/workspace-R3dmous3/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/r3dmous3/r3dmous3_workspace |
| Github URL            | http://github.com/r3dmous3/workspace-R3dmous3 |
| Test URL              | https://preview.c9users.io/r3dmous3/r3dmous3_workspace/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/r3dmous3/workspace-R3dmous3/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-r3dmous3"], // the id you gave your workspace
      function(myWorkspaceR3dmous3) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / r3dmous3 just got loaded.", myWorkspaceR3dmous3);
        myWorkspaceR3dmous3.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-r3dmous3"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / r3dmous3"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace r3dmous3."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/r3dmous3/workspace-R3dmous3/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/r3dmous3/r3dmous3_workspace"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/r3dmous3/workspace-R3dmous3"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://r3dmous3_workspace-r3dmous3.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
follows the standard template for workspace pulldown menus.</td></tr><tr valign="top"><td>setupResize</td><td>function</td><td>function () <br><br>Listen to window resize event.</td></tr><tr valign="top"><td>onResize</td><td>function</td><td>function () <br><br>When browser window resizes, forcibly resize the Console window</td></tr><tr valign="top"><td>loadTemplateWidget</td><td>function</td><td>function (callback) <br><br>Load the Template widget via chilipeppr.load() so folks have a r3dmous3
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial Port JSON Server widget via chilipeppr.load()</td></tr><tr valign="top"><td>load3dviewerWidget</td><td>function</td><td>function (callback) <br><br>Load the 3D Viewer Server widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadConsoleWidget</td><td>function</td><td>function (callback) <br><br>Load the Console widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
