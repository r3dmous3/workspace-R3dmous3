...
cprequire_test(["inline:com-chilipeppr-workspace-r3dmous3"], function(ws) {
    ...
    $('title').html("r3dmous3 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-r3dmous3", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-r3dmous3", // Make the id the same as the cpdefine id
        name: "Workspace / r3dmous3", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace r3dmous3.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a r3dmous3
        ...
        /**
         * Load the 3D Viewer Server widget via chilipeppr.load()
         */
